Feature: U7002 - As Jackie Wei, I want to catalog identified plants into my personal collection, so that I can keep track of the plants I've discovered.
  ...
  Scenario Outline: #AC3 - Invalid name or description
    ...
    Examples:
      ...
      | "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean@" | "Apple"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | "Plant name cannot be empty and must only include letters, numbers, spaces, dots, hyphens or apostrophes <br/>Plant name must be less than 64 characters" |
      | "😀"                                                                | "Apple"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | "Plant name cannot be empty and must only include letters, numbers, spaces, dots, hyphens or apostrophes <br/>"                                           |
