Feature: U15 As Kaia, I want to specify an actual address for my different recorded gardens,
  ...
  @U15_AC5.1
  Scenario: AC5.1 - A user attempts to create a garden without specifying the city and country
  ...
  @U15_AC5.2
  Scenario: AC5.2 - A user attempts to create a garden without specifying the city and country
    Given I am on the create new garden form
