...
//
//    @Test
//    void GivenNoUsersGardenExists_WhenDetailsRequested_ControllerRedirects() throws IOException, URISyntaxException, InterruptedException {
//        Mockito.when(mockGardenService.getGardensByGardenerId(any(long.class))).thenReturn(mockGardens);
...
//
//    @Test
//    void GivenGardenIDIsNull_WhenDetailsRequested_ControllerRedirects() throws IOException, URISyntaxException, InterruptedException {
...
//
//    @Test
//    void GivenUsersGardenExistsWithoutWeather_WhenDetailsRequested_ControllerFindsDetails() throws IOException, URISyntaxException, InterruptedException {
//        gardenDetailsController.gardenDetails("1", null, null, null, mockModel, mockRequest);
//    }
//
//    @Test
//    void GivenFriendsGardenExists_WhenDetailsRequested_ControllerFindsDetails() throws IOException, URISyntaxException, InterruptedException {
//        gardenDetailsController.gardenDetails("1", null, null, null, mockModel, mockRequest);
//    }
//
//    @Test
//    void GivenNonFriendsGardenExists_WhenDetailsRequested_ControllerRedirects() throws IOException, URISyntaxException, InterruptedException {
//        gardenDetailsController.gardenDetails("1", null, null, null, mockModel, mockRequest);
//    }
//
//
