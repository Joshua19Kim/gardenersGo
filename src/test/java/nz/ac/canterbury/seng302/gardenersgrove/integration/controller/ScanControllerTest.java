        ...
        this.mockMvc
                .perform(
                        MockMvcRequestBuilders.multipart("/saveIdentifiedPlant")
                                ...
                                .content(jsonBody)
                                .with(csrf()))
                .andExpect(status().isBadRequest()).andExpect(jsonPath("$.nameError").value("Plant name cannot be empty and must only include letters, numbers, spaces, dots, hyphens or apostrophes <br/>"));
    }
}
