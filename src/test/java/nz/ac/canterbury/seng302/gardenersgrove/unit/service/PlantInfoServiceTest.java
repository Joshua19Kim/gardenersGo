...
public class PlantInfoServiceTest {
    ...
    void setUp() {
        ...
        plantInfoService = new PlantInfoService(apiKey, mockHttpClient);
    }
    ...
    void testSendRequest() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = plantInfoService.sendRequest(query);
    ...
    void testSendRequestThrowsIOException() throws IOException, InterruptedException {
        ...
        IOException exception = assertThrows(IOException.class, () -> {
            plantInfoService.sendRequest(query);
        });
