INSERT INTO gardener (first_name, last_name, DoB, email, password, profile_picture, bad_word_count) VALUES ('A', 'A', DATE '2004-01-07', 'joshua19kim@gmail.com', '$2a$10$5JkvOc65rJFRmpjOIeEOi.lBGL6ttCiV6dYHdMR2Cdlxu8s1cs26O', '/images/defaultProfilePic.png', 0);
...
INSERT INTO garden (gardener_id, name, location, suburb, city, country, postcode, size, PUBLIC_GARDEN, creation_date) VALUES (8, 'Riverbank Garden', '202 River Road', 'Riverside', 'Melbourne', 'Australia', '3000', '16', true, '2024-03-22');

INSERT INTO garden (gardener_id, name, location, suburb, city, country, postcode, size, PUBLIC_GARDEN, creation_date) VALUES (9, 'Downtown Green', '50 Main Street', null, 'New York', 'USA', '10001', '22', true, '2024-02-10');

INSERT INTO garden (gardener_id, name, location, suburb, city, country, postcode, size, PUBLIC_GARDEN, creation_date) VALUES (10, 'Central City Garden', '100 Center Plaza', null, 'Boston', 'USA', '02101', '30', true, '2024-01-05');

INSERT INTO garden (gardener_id, name, location, suburb, city, country, postcode, size, PUBLIC_GARDEN, creation_date) VALUES (11, 'Heritage Park', '89 Heritage Street', 'Oldtown', 'Sydney', 'Australia', '2000', '19', true, '2024-03-30');
