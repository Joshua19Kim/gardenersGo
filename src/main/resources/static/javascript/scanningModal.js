...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var defaultImageSrc = `${root}/images/defaultScanningImage.png`;
    imagePreview.src = defaultImageSrc
    plantNetLogo.src = `${root}/images/apiLogo/powered-by-plantnet-light.png`;
    ...
    identifyButton.addEventListener('click', function(event) {
        ...
        const identifyUrl = `${root}/identifyPlant`;
...
goToCollectionButton.addEventListener('click', function() {
    ...
    const saveUrl = `${root}/saveIdentifiedPlant`;
    fetch(saveUrl, {
        method: 'POST',
        headers: {
